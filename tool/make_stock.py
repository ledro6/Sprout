...
Модели растит сама модель приложения (папка Model/Botany: `Botany`,
`Grower` и рецепты по семействам) — здесь, на компьютере: телефон получает
их готовыми, открывает AR сразу и не греется сборкой. Детализация одна на
все телефоны — обычная.
...
Model/Workshop/Workshop.swift. Выход — наборы данных
