...
class StatsTest {
    ...
    fun languages() = checks {
        ...
        // Цифры — арабские, как у `String(format:locale:)` на iPhone.
        speak("ar")
        check(Lang.format("%lld растений", 2), "٢ نبتتان", "арабский: два")
        check(Lang.format("%lld растений", 7), "٧ نبتات", "арабский: few")
        check(Lang.format("%lld растений", 11), "١١ نبتة", "арабский: many")
        speak("ja")
