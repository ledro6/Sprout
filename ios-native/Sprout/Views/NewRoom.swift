...
/// «Новая комната» — страница за последней комнатой на главной. Имя пишут,
/// нажав на поле; готовые имена заводятся одним нажатием. Заведённая комната встаёт на место этой страницы, а «Новая
