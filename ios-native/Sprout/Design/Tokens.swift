...
enum Metrics {
    ...
    /// растяжки был бы виден верхний край. Совсем прозрачной её не
    /// сделать: под строкой проезжает заголовок раздела, крупный и
    /// чёрный, и сквозь растяжку он не должен читаться призраком.
