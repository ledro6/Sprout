...
struct Splash: View {
    /// Как зовут хозяина. Пусто — ещё не назвался, и здороваемся без
    /// имени.
    ///
    /// Приходит свойством, а не из окружения: заставка висит наложением
    /// поверх вкладок, а не внутри них, и сад в неё оттуда не достаёт.
    let owner: String
