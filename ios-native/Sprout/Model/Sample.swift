...
enum Sample {
    enum Verdict: Equatable, Sendable {
        ...
        var line: String {
            switch self {
            case .fine: "Модель построю по снимку."
            case .blurry: "Снимок мыльный — возьму готовую модель вида."
            case .dark: "Снимок тёмный — возьму готовую модель вида."
            case .bright: "Снимок пересвечен — возьму готовую модель вида."
            case .empty: "Растения на снимке не видно — возьму готовую модель вида."
            }
        }
    }
